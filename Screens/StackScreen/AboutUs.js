        ...
        <View style={styles.container}>
            <SafeAreaView style={styles.header}>
                ...
                <View style={{alignItems:'center'}}>
                    <Text style={[styles.title, {color:theme.color}]}>About Us</Text>
                </View>
            </SafeAreaView>
            <View style={[styles.body, {backgroundColor: theme.background}]}>
                <Image source={LogoImage} style={{width:120, height: 120}} />
                <Text style={[styles.text, {color: theme.color}]}>  SquadSync is a mobile application that allows users to create and join groups with friends. 
                ...
                <Text style={[styles.text, {color: theme.color}]}>  As people grow older they tend to get more busy with their lives. It is during these times that staying connected in a meaningful 
                ...
                <Text style={[styles.text, {color: theme.color}]}>  SquadSync aims to fix this issue and provide a solution to those friend groups who would like a unique way to stay connected into 
